...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { cantidad_sillas: @bus.cantidad_sillas, estado: @bus.estado, movil: @bus.movil, total_pasajeros: @bus.total_pasajeros } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { cantidad_sillas: @bus.cantidad_sillas, estado: @bus.estado, movil: @bus.movil, total_pasajeros: @bus.total_pasajeros } }
